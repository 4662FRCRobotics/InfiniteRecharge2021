...
public final class Constants {
    ...
    public static final class AutoConstants{
        ...
        public static final double kDISTANCE_2_LEFT = -0.3;
        public static final double kDISTANCE_2_MIDDLE = -0.0;
        public static final double kDISTANCE_2_RIGHT = -.3;
        public static final double kTURN_2_LEFT = .3;
        public static final double kTURN_2_MIDDLE = -0.0;
        public static final double kTURN_2_RIGHT = .3;
